...
const ALL_NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: 'anchor',
    type: 'group',
    modulo: 'terminal_comex',
    items: [
      { to: '/admin/comex/dashboard',       icon: 'dashboard',           label: 'Tablero Comex & BI' },
      { to: '/admin/comex/importaciones',   icon: 'flight_land',         label: 'Importaciones (Impo)' },
      { to: '/admin/comex/exportaciones',   icon: 'flight_takeoff',      label: 'Exportaciones (Expo)' },
      { to: '/admin/comex/plazoleta',       icon: 'grid_view',           label: 'Plazoleta & Stacking' },
      { to: '/admin/comex/balanza',         icon: 'scale',               label: 'Balanza / Báscula' },
      { to: '/admin/comex/tally',           icon: 'inventory_2',         label: 'Consolidado / Tally' },
      { to: '/admin/comex/vacios',          icon: 'event_repeat',        label: 'Devolución de Vacíos' },
      { to: '/admin/comex/ordenes-trabajo', icon: 'assignment',          label: 'Órdenes de Trabajo (OT)' },
      { to: '/admin/comex/tarifarios',      icon: 'request_quote',       label: 'Acuerdos Tarifarios' },
      { to: '/admin/comex/facturacion',     icon: 'receipt_long',        label: 'Facturación Comex' },
