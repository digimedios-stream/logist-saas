...
export default function Landing() {
  ...
  const [activeTab, setActiveTab] = useState('dms') // 'dms' | 'tms' | 'comex'
  ...
  const [comexSubTab, setComexSubTab] = useState('plazoleta') // 'plazoleta' | 'gemini' | 'balanza'

  // Datos de Contacto
  const contactoEmail = "movixlogistica@gmail.com"
  const contactoTelefono = "+54 9 3775 501495"
  const whatsappUrl = `https://wa.me/5493775501495?text=${encodeURIComponent('Hola! Me interesa solicitar una demo de la plataforma Movix Logística & Comex.')}`
    ...
    <div className="dark min-h-screen bg-[#111322] text-[#e5e2e2] font-sans relative overflow-x-hidden selection:bg-lazdin-emerald selection:text-black">
      ...
      <header className="sticky top-0 w-full z-40 bg-[#111322]/85 backdrop-blur-xl border-b border-white/10 shadow-[0_0_20px_rgba(6,182,212,0.08)]">
        <div className="flex justify-between items-center px-6 lg:px-12 py-4 max-w-[1440px] mx-auto">
          ...
          <nav className="hidden xl:flex gap-7 items-center text-sm font-medium text-slate-300">
            <a href="#soluciones" className="hover:text-cyan-400 transition-colors">Soluciones DMS & TMS</a>
            <a href="#novedades" className="hover:text-emerald-400 transition-colors">Nuevos Módulos</a>
            <a href="#comex" className="text-cyan-400 hover:text-cyan-300 transition-colors flex items-center gap-1.5 font-bold">
              <span className="px-2 py-0.5 rounded-full bg-cyan-500/20 text-[10px] border border-cyan-500/40">NUEVO</span>
              Terminal & Comex
            </a>
      ...
      <main className="relative z-10">
        ...
        {/* HERO SECTION (CENTRAL: DMS + TMS + ADEMÁS TERMINAL PORTUARIA & COMEX) */}
          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
              ...
              <p className="text-slate-400 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 font-normal leading-relaxed">
                Optimiza rutas, rastrea unidades en tiempo real sin interrupciones con <strong className="text-white">Foreground Service nativo</strong> y digitaliza toda tu operación en un solo sistema <strong className="text-cyan-400">DMS + TMS</strong>. Además, incorpora un módulo integral para <strong className="text-teal-300">Terminales Portuarias, Plazoleta WMS & Comercio Exterior</strong>.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
                ...
                <a
                  href="#comex"
                  className="bg-slate-900/80 border border-cyan-500/40 hover:border-cyan-400 px-7 py-4 rounded-xl font-bold text-cyan-300 transition-all text-base text-center backdrop-blur-md flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(6,182,212,0.2)]"
                >
                  <span className="material-symbols-outlined text-cyan-400 text-xl">anchor</span>
                  <span>Módulo Puerto & Comex</span>
                </a>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 relative flex justify-center items-center">
              <div className="w-full aspect-[16/10] bg-slate-900/90 rounded-2xl p-2 border border-slate-700/60 shadow-2xl backdrop-blur-xl relative z-10 overflow-hidden transform hover:rotate-1 transition-transform duration-500 group">
                <img
                  src="/Captura Panel de control.png"
                  alt="Dashboard Control Flotas y Logística"
                ...
                <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                  <div className="space-y-1">
                    <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 text-[10px] font-bold uppercase tracking-wider backdrop-blur-md border border-emerald-500/30">
                      GPS 24/7 & Despacho Satelital
                    </span>
                    <p className="text-white font-bold text-sm">Monitoreo de Flotas, Rutas y Entregas en Vivo</p>
                  </div>
                  <span className="material-symbols-outlined text-emerald-400 text-2xl group-hover:scale-125 transition-transform">
                    local_shipping
                  </span>
                </div>
              </div>
        ...
        <section className="max-w-[1440px] mx-auto px-6 lg:px-12 py-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-slate-900/60 border border-slate-800 p-6 rounded-2xl text-center backdrop-blur-md hover:border-cyan-500/50 transition-all">
              <p className="text-3xl sm:text-4xl font-extrabold text-cyan-400 font-mono">Puerto & IA</p>
              <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mt-2">Módulo Comex Gemini AI</p>
            </div>
          </div>
        </section>

        {/* ── 2. SECCIÓN SOLUCIONES INTEGRADAS (DMS vs TMS vs COMEX) ── */}
        <section id="soluciones" className="max-w-[1440px] mx-auto px-6 lg:px-12 py-20 border-t border-slate-800/80">
          <div className="text-center mb-12">
            ...
            {/* Selector de Pestañas Principales (3 tabs: DMS, TMS, Comex) */}
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              ...
              >
                ...
                Terminal Portuaria & Comex
                <span className="px-1.5 py-0.2 rounded bg-cyan-500/20 text-cyan-300 text-[9px] border border-cyan-500/40">NUEVO</span>
              </button>
            </div>
          </div>
        ...
        {/* ── 3. SECCIÓN DE NUEVAS FUNCIONALIDADES DESTACADAS (NOVEDADES) ── */}
        <section id="novedades" className="max-w-[1440px] mx-auto px-6 lg:px-12 py-20 border-t border-slate-800/80">
        ...
        {/* ── 4. SECCIÓN ESTELAR: TERMINAL PORTUARIA, DEPÓSITO FISCAL & COMERCIO EXTERIOR (COMEX) ── */}
